...
Il campo gamma (GEX) modula la fiducia ma NON è un semaforo verde: GEX positivo
significa che i market maker frenano i movimenti e che il rischio di CODA (perdite
estreme) è ridotto — non che il rientro andrà a segno. GEX negativo è invece un
fattore di rischio serio: i MM amplificano in entrambe le direzioni e il rientro
atteso può trasformarsi in accelerazione. Tratta il gamma positivo come
"contesto più sicuro", non come conferma del successo; il gamma negativo come
allarme.
